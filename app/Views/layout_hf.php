...
<footer
    class="bg-dark text-white d-flex flex-wrap justify-content-between align-items-center py-3 my-4 mb-0 border-top">
    ...
    <ul class="nav col-md-4 justify-content-end">
        <li class="nav-item"><a href="<?= route_to('visualisation.message') ?>"
